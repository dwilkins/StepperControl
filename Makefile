...
INSTALL_DIR = /home/dwilkins/source/arduino
PORT = /dev/ttyACM0
UPLOAD_RATE = 115200
...
$(ARDUINO)/WString.cpp $(ARDUINO)/Print.cpp /home/dwilkins/sketchbook/libraries/Stepper/Stepper.cpp
FORMAT = ihex
...
CINCS = -I$(ARDUINO) -I/home/dwilkins/sketchbook/libraries/Stepper
CXXINCS = -I$(ARDUINO) -I~/sketchbook/libraries/Stepper
...
upload: applet/$(TARGET).hex
	stty $(UPLOAD_RATE) raw ignbrk hup < $(PORT)
...
applet/$(TARGET).elf: $(TARGET).cpp applet/core.a
	$(CC) $(ALL_CFLAGS) -o $@ $(TARGET).cpp -L. applet/core.a $(LDFLAGS)
